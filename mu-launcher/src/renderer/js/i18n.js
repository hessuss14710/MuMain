const translations = {
  es: {
    ...
    errorNoCharacter: 'Introduce el nombre de tu personaje para jugar',
    themeDark: 'Oscuro',
    themeBlue: 'Azul MU',
    themeRed: 'Rojo MU',
    themeLight: 'Claro',
  ...
  en: {
    ...
    errorNoCharacter: 'Enter your character name to play',
    themeDark: 'Dark',
    themeBlue: 'MU Blue',
    themeRed: 'MU Red',
    themeLight: 'Light',
  ...
  pt: {
    ...
    errorNoCharacter: 'Digite o nome do seu personagem para jogar',
    themeDark: 'Escuro',
    themeBlue: 'Azul MU',
